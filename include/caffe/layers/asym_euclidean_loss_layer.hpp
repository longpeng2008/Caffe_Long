...
class AsymEuclideanLossLayer : public LossLayer<Dtype> {
 public:
  explicit AsymEuclideanLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param), diff_() {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "AsymEuclideanLoss"; }
  /**
   * Unlike most loss layers, in the AsymEuclideanLossLayer we can backpropagate
 ...
 protected:
  /// @copydoc AsymEuclideanLossLayer
  ...
  /**
   * @brief Computes the AsymEuclidean error gradient w.r.t. the inputs.
   *
   * Unlike other children of LossLayer, AsymEuclideanLossLayer \b can compute

#ifndef CAFFE_ADAPTED_WEIGHTED_SIGMOID_CROSS_ENTROPY_LOSS_LAYER_HPP_
#define CAFFE_ADAPTED_WEIGHTED_SIGMOID_CROSS_ENTROPY_LOSS_LAYER_HPP_
...
class AdaptedWeightedSigmoidCrossEntropyLossLayer : public LossLayer<Dtype> {
 public:
  explicit AdaptedWeightedSigmoidCrossEntropyLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "AdaptedWeightedSigmoidCrossEntropyLoss"; }

 protected:
  /// @copydoc AdaptedWeightedSigmoidCrossEntropyLossLayer
